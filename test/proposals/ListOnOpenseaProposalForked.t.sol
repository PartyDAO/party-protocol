...
contract ListOnOpenseaProposalForkedTest is Test, TestUtils, ZoraTestUtils, OpenseaTestUtils {
    ...
    function setUp() public onlyForked {
        ...
        globals.setAddress(LibGlobals.GLOBAL_SEAPORT, address(SEAPORT));
        globals.setAddress(LibGlobals.GLOBAL_CONDUIT_CONTROLLER, address(CONDUIT_CONTROLLER));
        impl = new TestableListOnOpenseaProposal(globals, ZORA);
