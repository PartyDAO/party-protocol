...
contract CrowdfundTest is LintJSON, TestUtils {
    ...
    function _createExpectedPartyOptions(
        ...
        Crowdfund.FixedGovernanceOpts memory fixedGovOpts = cf.getFixedGovernanceOpts();
        return
            Party.PartyOptions({
                name: defaultName,
                symbol: defaultSymbol,
                ...
                governance: PartyGovernance.GovernanceOpts({
                    ...
                    passThresholdBps: fixedGovOpts.passThresholdBps,
                    totalVotingPower: uint96(finalPrice),
                    feeBps: fixedGovOpts.feeBps,
                    feeRecipient: fixedGovOpts.feeRecipient
                }),
