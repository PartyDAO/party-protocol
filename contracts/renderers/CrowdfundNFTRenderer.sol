...
contract CrowdfundNFTRenderer is IERC721Renderer {
    ...
    function generateSVG1(string memory partyName) private view returns (string memory) {
        ...
        return string.concat(
            ...
            's steps(',
            steps.toString(),
            ') infinite;}.delay{animation-delay:',
            delay.toString(),
